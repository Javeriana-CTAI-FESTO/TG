...
echo echo Iniciando Nginx >> %NGINX_PATH%start_nginx.bat
echo call start "" "%NGINX_PATH%nginx.exe" >> %NGINX_PATH%start_nginx.bat
echo echo Nginx iniciado >> %NGINX_PATH%start_nginx.bat
echo call exit >> %NGINX_PATH%start_nginx.bat

REM Copia el archivo start_nginx.bat a la carpeta de inicio
echo Copiando el archivo start_nginx.bat a la carpeta de inicio
